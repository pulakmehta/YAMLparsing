...
class MergingScript:
    ...
    def mergeIndividualYamls(self, yaml_1,yaml_2):  
        ...
        try:
            ...
            raise TypeError("Error 3: Error in merging in ",yaml_2 ,". Please check if it follows YAML format")  #Error that there is an issue in merging the files
        return yaml_1
    ...
    def filesToParse(self):
        ...
        try:
            ...
            raise TypeError("Error 2: Some files may have error. Please check if they are in YAML format")
        return ()
    ...
    def main(self):
        try:
            if (path.isfile(self.pathLocation)==True):
                ...
                raise TypeError("Error 1: The path of the YAML provided has an error. Please check")
                
        except:
            raise TypeError("Error 99: There was an unknown error")
            
if __name__== "__main__":
    path_file = (r".\TestCase\5\test\test\5.yaml")
    x = MergingScript(path_file)
    x.main()
